...
export const metadata = {
  title: "Файл - ProInfo.uz",
};

export default async function SupportDownloadDetailPage({ params }) {
  const { locale, slug } = await params;
  const item = await getSupportMediaDetail({ locale, type: mediaTypes.download, slug });
